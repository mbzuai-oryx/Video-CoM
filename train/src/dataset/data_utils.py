...
from src.constants import (DEFAULT_IMAGE_TOKEN, DEFAULT_VIDEO_TOKEN,
                           LLAVA_IMAGE_TOKEN, LLAVA_VIDEO_TOKEN,
                           VISION_END_TOKEN, VISION_START_TOKEN)
...
def llava_to_openai(conversations, is_video=False):
    ...
    for conversation in conversations:
        if LLAVA_IMAGE_TOKEN in conversation["value"]:
            is_video = False
        if LLAVA_VIDEO_TOKEN in conversation["value"]:
            is_video = True
